...
import parseArchives from './parsers/archives.js';
import parseCurrent from './parsers/current.js';
import { readFileSync, writeFileSync } from 'fs';
import { callWebhook } from './utils/discordInteractions.js';
function getInformations() {
    return { email: process.env.EMAIL, password: process.env.PASSWORD, webhook: process.env.WEBHOOK_URL };
}
async function navigateToGenote(page, user) {
